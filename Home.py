...
if data and data["condition"] in ["control", "video_only"]:
    # This CSS hides the specific links in the sidebar
    st.markdown(
        """
        <style>
            a[href*="Dashboard"], a[href*="Strategies"] {
...
if data and data["condition"] in ["video_only", "full_intervention"]:
    ...
    st.markdown(
        """
        <div class="hero-box" style="margin-top: 15px;">
        <h2>"When I am your age, what kind of ocean will I inherit?"</h2>
        <p>
        Please take a moment to reflect on this message. This project helps university 
        students reflect on fast-fashion behaviour and build habits that protect future generations.
        </p>
        </div>
        """,
        unsafe_allow_html=True
